<?php $this->load->view('admin/template/header')?>
                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            <div class="image-area">
                                <img src="<?php echo base_url();?>assets/admin/images/user-lg.jpg" alt="AdminBSB - Profile Image" />
                            </div>
                                            ...
                                            <div class="panel-heading">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <img src="<?php echo base_url();?>assets/admin/images/user-lg.jpg" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="post">
                                                    ...
                                                    <div class="post-content">
                                                        <img src="<?php echo base_url();?>assets/admin/images/profile-post-image.jpg" class="img-responsive" />
                                                    </div>
                                                </div>
                                            </div>
   ...
   <!-- Custom Js -->
    ...
    <script src="<?php echo base_url();?>assets/admin/js/pages/examples/profile.js"></script>
