										...
										<div class="hpanel blog-box responsive-mg-b-30">
											<div class="panel-heading custom-blog-hd">
												<div class="media clearfix">
													<a class="pull-left">
															<img class="img-circle" src="<?php echo base_url();?>assets/admin/img/contact/2.jpg" alt="profile-picture">
														</a>
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="hpanel blog-box responsive-mg-b-30">
											<div class="panel-heading custom-blog-hd">
												<div class="media clearfix">
													<a class="pull-left">
															<img class="img-circle" src="<?php echo base_url();?>assets/admin/img/contact/1.jpg" alt="profile-picture">
														</a>
													<div class="media-body blog-std">
														<p>Created by: <span class="font-bold">Smith</span> </p>
														<p class="text-muted">21.03.2015</p>
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="hpanel blog-box responsive-mg-b-30">
											<div class="panel-heading custom-blog-hd">
												<div class="media clearfix">
													<a class="pull-left">
															<img class="img-circle" src="<?php echo base_url();?>assets/admin/img/contact/3.jpg" alt="profile-picture">
														</a>
													<div class="media-body blog-std">
														<p>Created by: <span class="font-bold">Smith</span> </p>
														<p class="text-muted">21.03.2015</p>
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<div class="hpanel blog-box">
											<div class="panel-heading custom-blog-hd">
												<div class="media clearfix">
													<a class="pull-left">
															<img class="img-circle" src="<?php echo base_url();?>assets/admin/img/contact/4.jpg" alt="profile-picture">
														</a>
													<div class="media-body blog-std">
														<p>Created by: <span class="font-bold">Smith</span> </p>
														<p class="text-muted">21.03.2015</p>
