...
<div class="hero-wrap hero-wrap-2" style="background-image: url(<?php echo base_url();?>assets/images/bg_2.jpg);" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo base_url();?>assets/images/person_1.jpg);"></div>
        	...
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo base_url();?>assets/images/person_2.jpg);"></div>
      				<div class="info text-center">
